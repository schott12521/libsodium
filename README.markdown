...
Note: In order to work with the Nano cryptocurrency, this particular fork has modified ed25519 keypair, sign (ty Dustin!), and open functions that use blake2b instead of sha512. Be sure to build off of the 'stable' branch. The static lib generated by the dist-build/ios.sh script is used in my forked [swift-sodium project](https://github.com/nebyark/swift-sodium). 
